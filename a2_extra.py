...
# does not use the DetectEnglish python file to analyze the potential plaintext for decryted text
# analysis.
# Good: - Have more than one chance at accepting a key
# Bad:  - Slower
#       - Greater amount of false positives
import math, sys
                ...
                for line in f:
                  for word in line.split():
                    if word.lower() == pw:
                        ...
                        print("Found Match")
                        print(pw)
                        check = input("Is this word correct: (y/n) ")
                        if check == "y":
                            print()
                            print("Key is: %d" % (k + 1))
